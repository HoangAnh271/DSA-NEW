...
{
    cout << "\n----------------------------\n";
    cout << "Running time: " << running_time1 << " milisecond | " << running_time2 << " milisecond" << endl;
...
void print_output_paramenter(int output_paramenter, float running_time, unsigned long long comparison)
{
    ...
    {
    case 0:
        cout << "Running time: " << running_time << " milisecond" << endl;
        break;
    case 1:
...
void countComparisonAlgorithm(int array[], int n, int algorithm, unsigned long long &count_comparison)
{
    ...
    */
    ...
    case 7:
        ...
        break;
    case 8:
        countComparisonShakerSort(array, n, count_comparison);
        break;
    case 9:
        countComparisonShellSort(array, n, count_comparison);
        break;
    case 10:
        countComparisonCountSort(array, n, count_comparison);
        break;
    case 11:
